...
- 🎮 Interested in **AI, data analysis, ML engineering, and game logic**
...
- 🤖 **[MLonBigData](https://github.com/wizrdcodes/MLonBigData)**
  MSc module work applying ML techniques to large-scale datasets using Python
  - Shows: classification metrics (precision/recall), train/test splitting, TensorFlow/PyTorch concepts, weekly lab work (weeks 2–6)
...
- **Libraries:** pandas, matplotlib, numpy, scikit-learn, TensorFlow / PyTorch (learning)
- **Tools:** PyCharm, Git & GitHub, Jupyter/Colab
- **Concepts:** basic data analysis, visualisation, game state management, modular design, ML classification, model evaluation
